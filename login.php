...
<head>
    ...
    <title>LOGIN | Student Attendance Management System - SchoolE</title>
...
<body class="">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
            <h1 class="py-5 text-center text-light">SchoolE - Student Attendance Management System - Admin</h1>
